...
const Placeorder = ({ params }: { params: { placeorder: string } }) => {
	...
	return (
		<div className="ml-32 mt-10">
			<Image className="mb-6 w-6 h-6" src={arrowleft}  alt={""} />
			<section className="flex items-start text-sm justify-around">
				...
				<div className="border px-10 py-7 rounded-2xl">
					<div className="text-base font-semibold text-primaryBgClr text-center">Order Form</div>
					<hr className="my-5" />
					<OrderForm />
				</div>
			</section>
			...
			<section className="my-1 mb-3">
				<div className="text-base font-semibold mb-4">Similar Products</div>
