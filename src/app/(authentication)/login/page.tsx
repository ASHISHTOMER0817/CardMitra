...
const Page = () => {
  ...
  <section className="w-full lg:w-1/2 max-w-md mb-8 lg:mb-0 lg:mr-8">
    ...
    Access your account effortlessly and pick up right where you left off    </p>
  </section>
{data?.name}

<Image src={`data:image/jpg;base64,${data?.image}`} alt='image' width={100} height={70} className='h-auto'/>
